...
echo ""
echo "Disabling Noctyrium window restoration..."
defaults write com.jd.Noctyrium NSQuitAlwaysKeepsWindows -bool false 2>/dev/null || true
defaults write com.apple.Noctyrium NSQuitAlwaysKeepsWindows -bool false 2>/dev/null || true

echo "Opening Noctyrium..."
open -na "$DEST_APP" --args --fresh-launch
