...
var body: some View {
    ...
    func startNewStudyDay() {
        ...
        try? today.write(toFile: manualStudyDayFile, atomically: true, encoding: .utf8)

        log(type: "System", minutes: 0, cards: 0, note: "Started new study day \(today)")
        runSuggestionSweep()
        refresh()
    }
...
struct Sidebar: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            HStack(spacing: 10) {
                PlayerAvatarImage(path: "\(NSHomeDirectory())/Medical School/09 Admin/App Data/Noctyrium/Player Icons/JD Player Icon.jpg")
