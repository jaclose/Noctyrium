...
struct CourseTrackerPage: View {
    ...
    var currentItems: [CourseTrackerItem] {
        if selectedLeaf == "T2 • NB3" {
            ...
            let nestedNB3 = loadCourseTracker("\(base)/09 Admin/App Data/Course Trackers/T2/nb3_tracker.csv")
            if !nestedNB3.isEmpty { return nestedNB3 }
        ...
        if selectedLeaf == "T2 • BSCE" {
            ...
            let nestedBSCE = loadCourseTracker("\(base)/09 Admin/App Data/Course Trackers/T2/bsce_tracker.csv")
            if !nestedBSCE.isEmpty { return nestedBSCE }
...
func modulePercent(_ key: String) -> String {
    ...
    func generatedModuleItems(for key: String) -> [CourseTrackerItem] {
        // No fake generated module prep.
        // NB3 is lecture/DLA/PQ based.
        // BSCE is module-prep based and comes from bsce_t2_tracker.csv.
        // Other modules stay empty until intentionally built.
        return []
    }
}
