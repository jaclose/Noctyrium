<div class="anki-stage">
  ...
  <main class="glass-card reactive-card back-card">
    <div class="edge-luster"></div>
    <div class="bottom-spawn"></div>

    <header class="topline spawn-1">
      <div class="logo-wrap">
        <img class="jd-logo" src="JD%20icon%20Background%20Removed-73f0ca74bc8f6b2d78a90adb67ed47657bd28f95.png">
      </div>
    </header>

    <section class="front-review spawn-2">
      {{Front}}
    </section>

    <div class="glass-divider spawn-3"></div>

    <section class="back-content spawn-4">
      {{Back}}
    </section>
  </main>
</div>
