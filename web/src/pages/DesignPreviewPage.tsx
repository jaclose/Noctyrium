...
const PREVIEW_METRICS: QuestionSetMetrics = {
  ...
  remaining: 8,
  completionPct: 60,
  currentMasteryCorrect: 10,
  currentMasteryQuestions: 12,
  currentMasteryPct: 83,
  currentMasteryTone: "gold",
  historicalCorrectAttempts: 13,
  historicalAttemptCount: 18,
  historicalAccuracyPct: 72,
  needsReview: 3,
  importConfidence: 91,
