...
import { Plus, Trash2, Pencil, Star, ExternalLink, Search, ListPlus, Link as LinkIcon, HardDrive, EyeOff, CheckCircle2, Brain, ChevronDown } from "lucide-react";
...
import { BLUEPRINTS, blueprintResourcePayload, blueprintTrackerRows, blueprintsForTrack } from "../lib/blueprints";
...
export function ResourcesPage() {
  ...
  return (
    <>
      ...
      <BlueprintCommand blueprints={tailoredBlueprints} allBlueprints={BLUEPRINTS} />
