...
import { Download, Upload, RotateCcw, ImagePlus, SlidersHorizontal, UserCircle2 } from "lucide-react";
    ...
    >
      <div className="filter-bar" style={{ marginBottom: 4 }}>
        <button className={`filter-pill ${tab === "general" ? "on" : ""}`} onClick={() => setTab("general")}>
          <SlidersHorizontal size={13} style={{ marginRight: 6, verticalAlign: -2 }} /> General
        </button>
